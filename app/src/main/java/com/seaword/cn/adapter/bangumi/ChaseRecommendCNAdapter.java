...
public class ChaseRecommendCNAdapter extends BaseQuickAdapter<RecommendBangumi.RecommendCnBean.RecommendBean,BaseViewHolder> {

    public ChaseRecommendCNAdapter(List<RecommendBangumi.RecommendCnBean.RecommendBean> data) {
    ...
    /** 隐藏了最下方的观看状态 */
    @Override
    protected void convert(BaseViewHolder holder, RecommendBangumi.RecommendCnBean.RecommendBean item) {
        Glide.with(mContext)
                .load(item.getCover())
                .centerCrop()
